  ...
  return (
    <div className="container mx-auto  px-4 py-16">
      <section className="text-center mb-30">
        <AnimatedGlobe />
        <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight"> <span className="text-green-600">Swachh</span> AI <span className="text-green-600">Sustainable</span> AI</h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8"> Join our initiative in making waste management more efficient and success !</p>
        <Button className=" hover:bg-green-600 text-white text-lg py-6 px-10 ">Found Waste ?</Button>
...
<FeatureCard
      ...
      <section className="bg-white p-10 rounded-3xl shadow-lg mb-20">
        <h2 className="text-center font-bold text-4xl text-gray-800"><span className="text-green-600">Cleanup</span> Data</h2>
